...
#include <sys/stat.h>
#include <fcntl.h>
#define MYSEM "/mysemaphore824"
#define MYSEM1 "/mysemaphore825"
...
int main() {
	roomwait = sem_open(MYSEM, O_CREAT, S_IRUSR | S_IWUSR, 1);
    mutex = sem_open(MYSEM1, O_CREAT, S_IRUSR | S_IWUSR, 1);	
